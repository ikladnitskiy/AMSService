...
VALUES (20000, 'LE', 000078, 'East', 'Leningradskay obl., Kirovskiy r-n, pos. Mga', 'MAST', 72.0, 'Butorin', parsedatetime('10-12-2019', 'dd-MM-yyyy'), 'Orehov', parsedatetime('13-12-2019', 'dd-MM-yyyy'), false),
       ...
       (20017, 'EK', 000075, 'Ekaterinburg', 'Sverdlovskaya obl, g. Kachkanar, ul. Sverdlova, d. 39/1', 'MAST', 15.0, 'Bespalov', parsedatetime('16.04.2020', 'dd.MM.yyyy'), null, null, false),
       (20018, 'EK', 000080, 'Ekaterinburg', 'Sverdlovskaya obl, Nigneserginskiy r-n, der. Urazaevo', 'TOWER', 30.0, 'Krivorukov', parsedatetime('17.04.2020', 'dd.MM.yyyy'), 'Dolgodumov', null, false),
